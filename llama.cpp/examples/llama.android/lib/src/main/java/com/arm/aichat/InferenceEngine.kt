...
interface InferenceEngine {
    ...
    /**
     * Sends a user prompt and returns a Flow of raw token strings.
     */
    fun sendUserPrompt(message: String, predictLength: Int = DEFAULT_PREDICT_LENGTH): Flow<String>

    /**
     * Sends a user prompt and returns a Flow of [ReasoningToken], separating
     * Qwen3 <think> chain-of-thought tokens from final content tokens.
     */
    fun sendUserPromptWithReasoning(
        message: String,
